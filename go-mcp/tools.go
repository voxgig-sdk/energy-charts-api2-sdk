...
type Args struct {
	Entity string         `json:"entity" jsonschema:"public_power"`
	Query  map[string]any `json:"query,omitempty" jsonschema:"optional match map e.g. {\"id\":1} for load, omit for list"`
}

func registerTools(server *mcp.Server, client *sdk.EnergyChartsApi2SDK) {
	mcp.AddTool(server, &mcp.Tool{
		Name: "energy-charts-api2_list",
		Description: "List records from EnergyChartsApi2. " +
	...
	mcp.AddTool(server, &mcp.Tool{
		Name: "energy-charts-api2_load",
		Description: "Load a single record from EnergyChartsApi2. " +
...
func runOp(client *sdk.EnergyChartsApi2SDK, op string, args Args) (*mcp.CallToolResult, any, error) {
