...
require_relative 'EnergyChartsApi2_types'
...
class EnergyChartsApi2SDK
  ...
  def initialize(options = {})
    ...
    utility = EnergyChartsApi2Utility.new
    @_utility = utility
    ...
    feature_opts = EnergyChartsApi2Helpers.to_map(VoxgigStruct.getprop(@options, "feature"))
    if feature_opts
      featureorder = VoxgigStruct.getpath(@options, "__derived__.featureorder")
      if featureorder.is_a?(Array)
        featureorder.each do |fname|
          fopts = EnergyChartsApi2Helpers.to_map(feature_opts[fname])
          if fopts && fopts["active"] == true
            utility.feature_add.call(@_rootctx, EnergyChartsApi2Features.make_feature(fname))
          end
        end
      end
    end
  ...
  def get_utility
    EnergyChartsApi2Utility.copy(@_utility)
  end
  ...
  def prepare(fetchargs = {})
    ...
    ctrl = EnergyChartsApi2Helpers.to_map(VoxgigStruct.getprop(fetchargs, "ctrl")) || {}
    ...
    params = EnergyChartsApi2Helpers.to_map(VoxgigStruct.getprop(fetchargs, "params")) || {}
    query = EnergyChartsApi2Helpers.to_map(VoxgigStruct.getprop(fetchargs, "query")) || {}
    ...
    ctx.spec = EnergyChartsApi2Spec.new({
  ...
  def raw_request(fetchargs = {})
    ...
    rescue EnergyChartsApi2Error => err
    ...
    if fetched.is_a?(Hash)
      status = EnergyChartsApi2Helpers.to_int(VoxgigStruct.getprop(fetched, "status"))
  ...
  def graphql(query, variables = nil, ctrl = nil)
    ...
    if errors.is_a?(Array) && !errors.empty?
      ...
      res["ok"] = false
      res["err"] = EnergyChartsApi2Error.new(
        "graphql_error", "EnergyChartsApi2SDK: graphql: #{msg}")
      res["graphql"] = errors
    end
  ...
  def self.test(testopts = nil, sdkopts = nil)
    ...
    sdk = EnergyChartsApi2SDK.new(sdkopts)
    sdk.mode = "test"
    sdk
  end
end
