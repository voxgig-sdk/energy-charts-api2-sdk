...
#      offline in seeded test mode (EnergyChartsApi2SDK.test) against the real
...
class ReadmeExamplesTest < Minitest::Test
  ...
  SDK = File.join(__dir__, "..", "EnergyChartsApi2_sdk.rb")
  SDK_CLASS = "EnergyChartsApi2SDK"
