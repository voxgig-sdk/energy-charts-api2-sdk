...
from energychartsapi2_sdk.core.control import EnergyChartsApi2Control
...
from energychartsapi2_sdk.core.helpers import get_ctx_prop, to_map
...
class EnergyChartsApi2Context:
    def __init__(self, ctxmap=None, basectx=None):
        ...
        # Ctrl
        self.ctrl = EnergyChartsApi2Control()
        ...
        if isinstance(sp, EnergyChartsApi2Spec):
            self.spec = sp
        elif basectx is not None:
        ...
        if isinstance(r, EnergyChartsApi2Result):
            self.result = r
        elif basectx is not None:
        ...
        if isinstance(rp, EnergyChartsApi2Response):
            self.response = rp
        elif basectx is not None:
    ...
    def resolve_op(self, opname):
        ...
        if opname == "":
            return EnergyChartsApi2Operation({})
    ...
    def make_error(self, code, msg):
        return EnergyChartsApi2Error(code, msg, self)
