...
from energychartsapi2_sdk.utility import register

# Load features
from energychartsapi2_sdk.feature.base_feature import EnergyChartsApi2BaseFeature
from energychartsapi2_sdk.features import _has_feature, _make_feature
...
class EnergyChartsApi2SDK:
    ...
    def __init__(self, options=None):
        ...
        utility = EnergyChartsApi2Utility()
    ...
    def get_utility(self):
        return EnergyChartsApi2Utility.copy(self._utility)
    ...
    def graphql(self, query, variables=None, ctrl=None):
        ...
        if isinstance(errors, list) and 0 < len(errors):
            ...
            res["ok"] = False
            res["err"] = Exception("EnergyChartsApi2SDK: graphql: " + str(msg))
            res["graphql"] = errors
    ...
    def PublicPower(self, data=None) -> "PublicPowerEntity":
        ...
        from energychartsapi2_sdk.entity.public_power_entity import PublicPowerEntity
