...
from energychartsapi2_sdk.energychartsapi2_types import (
    PublicPower,
...
class PublicPowerEntity:
    ...
    def match_get(self) -> PublicPower:
    ...
    def list(self, reqmatch=None, ctrl=None) -> list[PublicPower]:
        utility = self._utility
        # reqmatch is optional: an omitted match lists all records. Treat None
        # as an empty match so client.PublicPower().list() works with no args.
        if reqmatch is None:
            reqmatch = {}
