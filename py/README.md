...
The Python SDK for the EnergyChartsApi2 API. Provides an entity-oriented interface following Pythonic conventions.
...
result, err = client.EnergyChartsApi2(None).load(
    {"id": "test01"}, None
)
