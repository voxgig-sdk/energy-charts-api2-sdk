# EnergyChartsApi2 Python SDK



The Python SDK for the EnergyChartsApi2 API — an entity-oriented client following Pythonic conventions.

The SDK exposes the API as capitalised, semantic **Entities** — for example `client.PublicPower()` — each
...
release tag (`py/vX.Y.Z`, see [Releases](https://github.com/voxgig-sdk/energy-charts-api2-sdk/releases)) or
...
```
py/
├── energychartsapi2_sdk.py         -- Main SDK module
