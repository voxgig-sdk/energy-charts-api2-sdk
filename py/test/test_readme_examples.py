# EnergyChartsApi2 SDK — root README python-examples test.
#
...
def test_readme_python_blocks_typecheck():
    ...
    with tempfile.TemporaryDirectory() as td:
        ...
        # Resolve "from energychartsapi2_sdk import EnergyChartsApi2SDK" against the package root.
...
def test_readme_testmode_snippets_run():
    ...
    for i, block in enumerate(blocks):
        ...
        namespace = {"EnergyChartsApi2SDK": EnergyChartsApi2SDK, "os": os}
        try:
