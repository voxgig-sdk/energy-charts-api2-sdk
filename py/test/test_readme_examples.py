# EnergyChartsApi2 SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions EnergyChartsApi2SDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both EnergyChartsApi2SDK(...) and EnergyChartsApi2SDK.test(...) become
#      EnergyChartsApi2SDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "energychartsapi2_sdk"
_SDK_CLASS = "EnergyChartsApi2SDK"
