...
func registerSDKWords(r *eng.Registry, client *sdk.EnergyChartsApi2SDK) {
...
func runOp(client *sdk.EnergyChartsApi2SDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
