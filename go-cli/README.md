...
AQL-driven CLI and REPL for the EnergyChartsApi2 SDK. Positional arguments are
...
```sh
go build -o energy-charts-api2-cli ./...
```
...
./energy-charts-api2-cli load 1 public_power
./energy-charts-api2-cli load '{id:1}' public_power
