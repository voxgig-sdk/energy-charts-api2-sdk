// Command EnergyChartsApi2-cli is a CLI + REPL for the EnergyChartsApi2 SDK,
...
func usage(out io.Writer) {
	...
	fmt.Fprintln(out, "Env:      ENERGY_CHARTS_API2_APIKEY (api key), ENERGY_CHARTS_API2_BASE (base url override)")
