...
// EnergyChartsApi2 SDK clienttrack feature
...
class EnergyChartsApi2ClienttrackFeature extends EnergyChartsApi2BaseFeature
{
    ...
    public function PostConstruct(EnergyChartsApi2Context $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'EnergyChartsApi2-SDK';
