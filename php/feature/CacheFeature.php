...
// EnergyChartsApi2 SDK cache feature
...
class EnergyChartsApi2CacheFeature extends EnergyChartsApi2BaseFeature
{
    ...
    private function _through(EnergyChartsApi2Context $ctx, string $url, array $fetchdef, callable $inner): array
    {
