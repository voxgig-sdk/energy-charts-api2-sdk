...
// EnergyChartsApi2 SDK timeout feature
...
class EnergyChartsApi2TimeoutFeature extends EnergyChartsApi2BaseFeature
{
    ...
    private function _with_timeout(EnergyChartsApi2Context $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(EnergyChartsApi2Context $_ctx, float $ms): void
    {
        $client = $this->client;
