...
// EnergyChartsApi2 SDK ratelimit feature
...
class EnergyChartsApi2RatelimitFeature extends EnergyChartsApi2BaseFeature
{
    ...
    private function _acquire(EnergyChartsApi2Context $ctx): void
    {
    ...
    private function _track(EnergyChartsApi2Context $_ctx, float $wait_ms): void
    {
        $client = $this->client;
