...
// EnergyChartsApi2 SDK metrics feature
...
class EnergyChartsApi2MetricsFeature extends EnergyChartsApi2BaseFeature
{
    ...
    private function _record(EnergyChartsApi2Context $ctx, bool $ok): void
    {
