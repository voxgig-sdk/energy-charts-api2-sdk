...
class EnergyChartsApi2SDK
{
    ...
    public function __construct(array $options = [])
    {
        ...
        $feature_opts = EnergyChartsApi2Helpers::to_map(Struct::getprop($this->options, "feature"));
        if ($feature_opts) {
            $featureorder = Struct::getpath($this->options, "__derived__.featureorder");
            if (is_array($featureorder)) {
                foreach ($featureorder as $fname) {
                    $fopts = EnergyChartsApi2Helpers::to_map($feature_opts[$fname] ?? null);
                    if ($fopts && isset($fopts["active"]) && $fopts["active"] === true) {
                        ...
                        if (!EnergyChartsApi2Features::has_feature($fname)) {
                        ...
                        ($utility->feature_add)($this->_rootctx, EnergyChartsApi2Features::make_feature($fname));
                    }
                }
            }
        }
    ...
    {
        return EnergyChartsApi2Utility::copy($this->_utility);
    }
    ...
    public function prepare(array $fetchargs = []): mixed
    {
        ...
        $ctrl = EnergyChartsApi2Helpers::to_map(Struct::getprop($fetchargs, "ctrl")) ?? [];
        ...
        $params = EnergyChartsApi2Helpers::to_map(Struct::getprop($fetchargs, "params")) ?? [];
        $query = EnergyChartsApi2Helpers::to_map(Struct::getprop($fetchargs, "query")) ?? [];
    ...
    private function op_denied(string $op): array
    {
        ...
        return [
            "ok" => false,
            "err" => new EnergyChartsApi2Error($op . "_allow",
                "EnergyChartsApi2SDK: " . $op . ": operation not allowed by" .
    ...
    private function raw_request(array $fetchargs = []): mixed
    {
        ...
        if (is_array($fetched)) {
            $status = EnergyChartsApi2Helpers::to_int(Struct::getprop($fetched, "status"));
    ...
    public function graphql(string $query, ?array $variables = null, ?array $ctrl = null): mixed
    {
        ...
        if (is_array($errors) && 0 < count($errors)) {
            ...
            $res["ok"] = false;
            $res["err"] = new EnergyChartsApi2Error("graphql_error",
                "EnergyChartsApi2SDK: graphql: " . $msg);
            $res["graphql"] = $errors;
        }
    ...
    public function PublicPower($data = null)
    {
        ...
        if ($data === null) {
            if ($this->_public_power === null) {
                $this->_public_power = new PublicPowerEntity($this, null);
            }
            return $this->_public_power;
        }
    ...
    public static function test(?array $testopts = null, ?array $sdkopts = null): self
    {
        ...
        $sdk = new EnergyChartsApi2SDK($sdkopts);
        $sdk->mode = "test";
        return $sdk;
    }
}
