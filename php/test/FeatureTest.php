...
// EnergyChartsApi2 SDK feature test
//
...
class FtCtrl extends EnergyChartsApi2Control
{
...
class FtClient
{
    ...
    private EnergyChartsApi2Utility $utility;

    public function __construct(EnergyChartsApi2Utility $utility, array $options)
    {
    ...
    public function get_utility(): EnergyChartsApi2Utility
    {
        return $this->utility;
    }
}
...
class FtRecorder
{
    ...
    {
        return function (EnergyChartsApi2Context $_ctx, string $url, array $fetchdef): array {
...
class FtHarness
{
    ...
    public function __construct(
        ...
        $utility = new EnergyChartsApi2Utility();
        $this->utility = $utility;

        $utility->fetcher = $server ?? function (EnergyChartsApi2Context $_ctx, string $_url, array $fetchdef): array {
        ...
        foreach ($features as $fspec) {
            ...
            $f = EnergyChartsApi2Config::make_feature($name);
    ...
    private static function buildUrl(EnergyChartsApi2Spec $spec): string
    {
        $keys = [];
    ...
    public function op(array $o = []): array
    {
        ...
        if (($ctx->out['point'] ?? null) instanceof EnergyChartsApi2Error) {
        ...
        if (is_array($fetched)) {
            $ctx->response = new EnergyChartsApi2Response($fetched);
        }
    ...
    private function fail(EnergyChartsApi2Context $ctx, mixed $err): array
    {
...
class FeatureTest extends TestCase
{
    ...
    public function test_retry_retries_a_transport_error_until_exhausted(): void
    {
        ...
        $clock = new FtClock();
        $n = 0;
        $server = function (EnergyChartsApi2Context $ctx, string $_url, array $_fd) use (&$n): array {
            $n++;
