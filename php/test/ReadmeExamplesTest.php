...
// EnergyChartsApi2 SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (EnergyChartsApi2SDK::test)
...
{
    private const SDK_CLASS = 'EnergyChartsApi2SDK';
    ...
    private const SDK_BASE = 'energychartsapi2_sdk';
    ...
    public function test_php_examples_run_offline(): void
    {
        $ran = 0;
        $failures = [];
        $sdk = __DIR__ . '/../energychartsapi2_sdk.php';
        foreach ($this->phpBlocks() as $blk) {
