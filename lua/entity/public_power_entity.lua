...
function PublicPowerEntity:mark_deleted()
  self._deleted = true
end


function PublicPowerEntity:deleted()
...
function PublicPowerEntity:stream(action, args, callopts)
...
---@param reqmatch PublicPowerListMatch
---@param ctrl? table
---@return PublicPower[]
---@return string? err
