...
function runner.env_override(m)
  local live = runner.getenv("ENERGYCHARTSAPI2_TEST_LIVE")
  local override = runner.getenv("ENERGYCHARTSAPI2_TEST_OVERRIDE")
  ...
  local explain = runner.getenv("ENERGYCHARTSAPI2_TEST_EXPLAIN")
