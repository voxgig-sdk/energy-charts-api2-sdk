...
func envOverride(m map[string]any) map[string]any {
	if os.Getenv("ENERGY_CHARTS_API2_TEST_LIVE") == "TRUE" ||
		os.Getenv("ENERGY_CHARTS_API2_TEST_OVERRIDE") == "TRUE" {
		for key := range m {
	...
	if explain := os.Getenv("ENERGY_CHARTS_API2_TEST_EXPLAIN"); explain != "" {
