...
type EnergyChartsApi2SDK struct {
	Mode     string
...
func (sdk *EnergyChartsApi2SDK) OptionsMap() map[string]any {
...
func (sdk *EnergyChartsApi2SDK) GetUtility() *Utility {
	return CopyUtility(sdk.utility)
}

func (sdk *EnergyChartsApi2SDK) GetRootCtx() *Context {
	return sdk.rootctx
}

func (sdk *EnergyChartsApi2SDK) Prepare(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *EnergyChartsApi2SDK) Direct(fetchargs map[string]any) (map[string]any, error) {
...
func (sdk *EnergyChartsApi2SDK) opAllowed(op string) bool {
	allowOp, _ := vs.GetPath(sdk.options, []any{"allow", "op"}).(string)
	return strings.Contains(allowOp, op)
}

func (sdk *EnergyChartsApi2SDK) opDenied(op string) map[string]any {
	allowOp, _ := vs.GetPath(sdk.options, []any{"allow", "op"}).(string)
	return map[string]any{
		"ok": false,
		"err": fmt.Errorf("EnergyChartsApi2SDK: %s: operation not allowed by"+
...
// gate by passing it.
func (sdk *EnergyChartsApi2SDK) rawRequest(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *EnergyChartsApi2SDK) Graphql(
	...
	if 0 < len(errors) {
		...
		res["ok"] = false
		res["err"] = fmt.Errorf("EnergyChartsApi2SDK: graphql: %s", msg)
		res["graphql"] = errors
	}
...
func TestSDK(testopts map[string]any, sdkopts map[string]any) *EnergyChartsApi2SDK {
	...
	sdk := NewEnergyChartsApi2SDK(sdkopts)
	sdk.Mode = "test"
