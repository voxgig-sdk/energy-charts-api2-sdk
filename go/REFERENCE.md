# EnergyChartsApi2 Golang SDK Reference

Complete API reference for the EnergyChartsApi2 Golang SDK.
...
#### `TestSDK(testopts, sdkopts map[string]any) *EnergyChartsApi2SDK`
