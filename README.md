...
| --- | --- | --- |
| TypeScript | `@voxgig-sdk/energy-charts-api2` | `npm install @voxgig-sdk/energy-charts-api2` |
| Python | `voxgig-sdk-energy-charts-api2` | `pip install voxgig-sdk-energy-charts-api2` |
| PHP | `voxgig-sdk/energy-charts-api2` | `composer require voxgig-sdk/energy-charts-api2` |
| Golang | `github.com/voxgig-sdk/energy-charts-api2-sdk/go` | `go get github.com/voxgig-sdk/energy-charts-api2-sdk/go` |
| Ruby | `voxgig-sdk-energy-charts-api2` | `gem install voxgig-sdk-energy-charts-api2` |
| Lua | `voxgig-sdk-energy-charts-api2` | `luarocks install voxgig-sdk-energy-charts-api2` |
...
- Upstream API: [https://www.freepublicapis.com/api/random](https://www.freepublicapis.com/api/random)
