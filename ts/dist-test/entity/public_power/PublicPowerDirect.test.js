...
(0, node_test_1.describe)('PublicPowerDirect', async () => {
    ...
    (0, node_test_1.test)('direct-exists', async () => {
        const sdk = new __1.EnergyChartsApi2SDK({
    ...
    (0, node_test_1.test)('direct-list-public_power', async (t) => {
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-public_power', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        const client = new __1.EnergyChartsApi2SDK(Object.assign({}, (0, utility_1.liveClientOptions)(), {}));
        let idmap = env['ENERGY_CHARTS_API2_TEST_PUBLIC_POWER_ENTID'];
    ...
    const client = new __1.EnergyChartsApi2SDK({
        base: 'http://localhost:8080',
...
//# sourceMappingURL=PublicPowerDirect.test.js.map