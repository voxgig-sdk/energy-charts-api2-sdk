...
function envOverride(m: Record<string, any>) {
  if (
    'TRUE' === process.env.ENERGYCHARTSAPI2_TEST_LIVE ||
    'TRUE' === process.env.ENERGYCHARTSAPI2_TEST_OVERRIDE
  ) {
  ...
  m.ENERGYCHARTSAPI2_TEST_EXPLAIN = process.env.ENERGYCHARTSAPI2_TEST_EXPLAIN || m.ENERGYCHARTSAPI2_TEST_EXPLAIN
