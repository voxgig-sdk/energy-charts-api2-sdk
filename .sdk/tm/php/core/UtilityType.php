...
// EnergyChartsApi2 SDK utility type

class EnergyChartsApi2Utility
{
    ...
    public static function copy(EnergyChartsApi2Utility $src): EnergyChartsApi2Utility
    {
        $u = new EnergyChartsApi2Utility();
        $u->clean = $src->clean;
        $u->done = $src->done;
