...
// EnergyChartsApi2 SDK utility: graphql
//
...
class EnergyChartsApi2Graphql
{
    ...
    // equivalent.
    public static function body(EnergyChartsApi2Context $ctx): mixed
    {
    ...
    public static function errors(EnergyChartsApi2Context $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;
