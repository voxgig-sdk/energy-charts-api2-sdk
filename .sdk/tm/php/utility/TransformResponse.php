...
// EnergyChartsApi2 SDK utility: transform_response

require_once __DIR__ . '/../core/Helpers.php';

class EnergyChartsApi2TransformResponse
{
    public static function call(EnergyChartsApi2Context $ctx): mixed
    {
        ...
        $transform = EnergyChartsApi2Helpers::to_map(\Voxgig\Struct\Struct::getprop($point, 'transform'));
        if (!$transform) {
            return null;
        }
