...
// EnergyChartsApi2 SDK utility: make_request

require_once __DIR__ . '/../core/Response.php';
require_once __DIR__ . '/../core/Result.php';

class EnergyChartsApi2MakeRequest
{
    public static function call(EnergyChartsApi2Context $ctx): array
    {
        ...
        if ($fetch_err) {
            ...
            $response = new EnergyChartsApi2Response(['err' => $ctx->make_error('request_no_response', 'response: undefined')]);
        } elseif (is_array($fetched)) {
            $response = new EnergyChartsApi2Response($fetched);
        } else {
