...
// EnergyChartsApi2 SDK utility: fetcher

class EnergyChartsApi2Fetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; EnergyChartsApi2SDK/1.0)';
    ...
    public static function call(EnergyChartsApi2Context $ctx, string $fullurl, array $fetchdef): array
    {
