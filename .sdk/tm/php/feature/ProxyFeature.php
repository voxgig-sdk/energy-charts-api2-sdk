...
// EnergyChartsApi2 SDK proxy feature
...
class EnergyChartsApi2ProxyFeature extends EnergyChartsApi2BaseFeature
{
    ...
    public function init(EnergyChartsApi2Context $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (EnergyChartsApi2Context $ctx2, string $url2, array $fetchdef) use ($inner): array {
