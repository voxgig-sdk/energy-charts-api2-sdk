...
// EnergyChartsApi2 SDK audit feature
...
class EnergyChartsApi2AuditFeature extends EnergyChartsApi2BaseFeature
{
    ...
    private function _emit(EnergyChartsApi2Context $ctx, string $outcome): void
    {
