...
// EnergyChartsApi2 SDK netsim feature
...
class EnergyChartsApi2NetsimFeature extends EnergyChartsApi2BaseFeature
{
    ...
    private function _simulate(EnergyChartsApi2Context $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
        $this->calls++;
        $call = $this->calls;
    ...
    private function _track(EnergyChartsApi2Context $ctx, array $applied): void
    {
        $client = $this->client;
