...
// EnergyChartsApi2 SDK rbac feature
...
class EnergyChartsApi2RbacFeature extends EnergyChartsApi2BaseFeature
{
    ...
    private function _required(EnergyChartsApi2Context $ctx): ?string
    {
    ...
    private function _reject(EnergyChartsApi2Context $ctx, string $required): void
    {
    ...
    private function _track(EnergyChartsApi2Context $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
